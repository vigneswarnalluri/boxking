                ...
                <div class="col-12">
                    <div class="single-page">
                        <div class="project-page-thumb mb-50">
                            <img class="w-100" src="assets/img/project/project_details1_1.png" alt="img">
                        ...
                        <div class="row gy-4 justify-content-center">
                            <div class="col-xl-4 col-lg-6">
                                <div class="service-card style4">
                                    ...
                                    <div class="service-card_content">
                                        <h4 class="service-card_title"><a href="service-details.php">Full Principal Contractor service</a></h4>
                            ...
                            <div class="col-xl-4 col-lg-6">
                                <div class="service-card style4">
                                    ...
                                    <div class="service-card_content">
                                        <h4 class="service-card_title"><a href="service-details.php">Full-time Onsite Supervision</a></h4>
                                        <p class="service-card_text">There are many passages of lorem ipsum available</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6">
                                <div class="service-card style4">
                                    ...
                                    <div class="service-card_content">
                                        <h4 class="service-card_title"><a href="service-details.php">Timber and steel frame construction</a></h4>
                                        <p class="service-card_text">There are many passages of lorem ipsum available</p>
                                    </div>
                                </div>
                            </div>
