        ...
        <div class="container">            
            <div class="row gy-30 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-card" data-bg-src="assets/img/bg/team-card-bg1-1.png">
                        <div class="team-card_content">
                            <h4 class="team-card_title"><a href="team-details.php">S. Arfan Sumon</a>
                            </h4>
                            <span class="team-card_desig">Head of Production</span>
                            <div class="team-social_wrap">
                                <div class="social-btn">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-card" data-bg-src="assets/img/bg/team-card-bg1-1.png">
                        <div class="team-card_content">
                            <h4 class="team-card_title"><a href="team-details.php">Aya Nikola</a>
                            </h4>
                            <span class="team-card_desig">Sr. Engineer</span>
                            <div class="team-social_wrap">
                                <div class="social-btn">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-card" data-bg-src="assets/img/bg/team-card-bg1-1.png">
                        <div class="team-card_content">
                            <h4 class="team-card_title"><a href="team-details.php">K. Mrajuk Rasel</a>
                            </h4>
                            <span class="team-card_desig">Sr. Engineer</span>
                            <div class="team-social_wrap">
                                <div class="social-btn">
