...
<body>
	...
	******************************** -->
    ...
    <div class="hero-wrapper hero-3" id="hero-sec">
        <div class="hero-bg-3-1" data-mask-src="assets/img/hero/hero_bg_mask_3_1.png" data-bg-src="assets/img/hero/hero_bg_3_1.png"></div>
        ...
        <div class="container">
            <div class="hero-style3">
                <div class="row">
                    <div class="col-lg-12">
                        <span class="hero-subtitle">Our Vision <img src="assets/img/icon/long-arrow-right2.svg" alt="img"></span>
...
<!--==============================
    ...
    <div class="cta-area-3">
        <div class="container">
            <div class="cta-wrap3 text-center" data-bg-src="assets/img/bg/cta-bg3-1.png" data-overlay="title" data-opacity="6">
                ...
                <div class="btn-wrap justify-content-center">
                    <a href="contact.php" class="btn">Get in Touch <i class="ri-arrow-right-up-line"></i></a>
                </div>
            </div>
        </div>
    </div>
