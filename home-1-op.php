...
<?php include './layouts/layout-top.php'?>
    ...
    Hero Area
    ==============================-->
    <div class="hero-wrapper hero-1" id="hero-sec" data-bg-src="assets/img/hero/hero_bg_1_1.png">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="hero-style1">
                                ...
                                <div class="btn-group">
                                    <a href="about.php" class="btn style2">Discover More <i class="ri-arrow-right-up-line"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>                
        ...
        <div class="hero-experience-wrap" data-bg-src="assets/img/hero/hero_experience_wrap_bg_1_1.png">
            ...
            <div class="media">
                ...
                <a class="link-btn" href="about.php">Let’s work together <img src="assets/img/icon/long-arrow-right.png" alt="img"></a>
            </div>
        </div>
    </div>
    <!--======== / Hero Section ========-->
    ...
    Service Area 01  
    ==============================-->
    <div class="service-area-1 space-top overflow-hidden" id="service-sec" data-bg-src="assets/img/bg/service-bg1-1.png">
        <div class="container">
                    ...
                    <div class="service-card">
                        ...
                        <div class="service-card_content">
                            ...
                            <div class="btn-wrap">
                                ...
                                <a href="service-details.php" class="btn">Explore Service <i class="ri-arrow-right-up-line"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="service-card">
                        ...
                        <div class="service-card_content">
                            ...
                            <h4 class="service-card_title"><a href="service-details.php">Property maintenance</a></h4>
                            <p class="service-card_text">There are many passages of lorem ipsum available</p>
                            <div class="btn-wrap">
                                <div class="icon-btn"><i class="ri-arrow-right-up-line"></i></div>
                                <a href="service-details.php" class="btn">Explore Service <i class="ri-arrow-right-up-line"></i></a>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="service-card">
                        ...
                        <div class="service-card_content">
                            ...
                            <h4 class="service-card_title"><a href="service-details.php">Virtual design & build</a></h4>
                            <p class="service-card_text">There are many passages of lorem ipsum available</p>
                            <div class="btn-wrap">
                                <div class="icon-btn"><i class="ri-arrow-right-up-line"></i></div>
                                <a href="service-details.php" class="btn">Explore Service <i class="ri-arrow-right-up-line"></i></a>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="service-card">
                        ...
                        <div class="service-card_content">
                            ...
                            <h4 class="service-card_title h5"><a href="service-details.php">Proconstruction</a></h4>
                            <p class="service-card_text">There are many passages of lorem ipsum available</p>
                            <div class="btn-wrap">
                                <div class="icon-btn"><i class="ri-arrow-right-up-line"></i></div>
                                <a href="service-details.php" class="btn">Explore Service <i class="ri-arrow-right-up-line"></i></a>
                ...
                <div class="col-lg-7">
                    <div class="cta-wrap-1 position-relative">
                        ...
                        <div class="title-area mb-40 text-md-start text-center">
                            <span class="sub-title"><img src="assets/img/icon/section-subtitle-icon.svg" alt="img">GET FREE QUOTE</span>
    ...
    <div class="space-top text-center overflow-hidden">
        ...
        <div class="container">
            <div class="title-area text-center">
                ...
                <span class="sub-title"><img src="assets/img/icon/section-subtitle-icon.svg" alt="img"> Why Choose Us</span>
    ...
    Process Area  
    ==============================-->
    <section class="process-area-1 space-top bg-attachment process-bg-half" data-bg-src="assets/img/bg/process-bg1-1.png" data-overlay="title" data-opacity="8">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-4 col-md-6">
                    <div class="title-area text-md-start text-center">
                        <span class="sub-title text-white"><img src="assets/img/icon/section-subtitle-icon.svg" alt="img">Work Process</span>
    ...
    Testimonial Area  
    ==============================-->
    <div class="testimonial-area-1 overflow-hidden space bg-smoke" data-bg-src="assets/img/bg/testimonial-bg1-1.png">
            ...
            <div class="row gx-100 gy-60 flex-row-reverse">                
                <div class="col-xl-6">
                    <div class="title-area">
                        <span class="sub-title"><img src="assets/img/icon/section-subtitle-icon.svg" alt="img">Testimonials</span>
                ...
                <div class="col-xl-6">
                    <div class="testimonial-card" data-bg-src="assets/img/bg/testimonial-card-bg1-1.png">
                        ...
                        <div class="btn-group">
                            <a href="contact.php" class="btn style6">Contact with Us <i class="ri-arrow-right-up-line"></i></a>
                        </div>
                    </div>
                </div>
            </div>         
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-7 col-md-7">
                    <div class="title-area text-md-start text-center">
                        <span class="sub-title"><img src="assets/img/icon/section-subtitle-icon.svg" alt="img">Our Team</span>
                        <h2 class="sec-title">Meet our leadership</h2>
                    </div>
                </div>
                <div class="col-md-auto">
                    <div class="sec-btn">
                        <a href="about.php" class="btn">View All Members <i class="ri-arrow-right-up-line"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row gy-30 justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="team-card" data-bg-src="assets/img/bg/team-card-bg1-1.png">
                        <div class="team-card_content">
                            <h4 class="team-card_title"><a href="team-details.php">Penelopa Miller</a>
                            </h4>
...
<!--==============================
    ...
    <div class="client-area-1 text-center space overflow-hidden" data-bg-src="assets/img/bg/client-bg1-1.png" data-overlay="title" data-opacity="9">
        ...
        <div class="container">
            <div class="title-area text-center">
                <span class="sub-title text-white"><img src="assets/img/icon/section-subtitle-icon.svg" alt="img">Happy Clients</span>
            ...
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="title-area text-lg-start text-center">
                        <span class="sub-title"><img src="assets/img/icon/section-subtitle-icon.svg" alt="img">Latest News</span>
                        <h2 class="sec-title">Recent news and events</h2>
                    </div>
                </div>
                <div class="col-md-auto">
                    <div class="sec-btn">
                        <a href="blog.php" class="btn style-border">View All News <i class="ri-arrow-right-up-line"></i></a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="blog-details.php" class="btn">More Details <i class="ri-arrow-right-up-line"></i></a>
                        </div>
                    </div>
                </div>
    ...
    Contact Area  
    ==============================-->
    <section class="contact-area-1 space bg-title overflow-hidden" id="contact-sec" data-bg-src="assets/img/bg/contact-bg1-1.png">
