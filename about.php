                ...
                <div class="col-xl-6">
                    <div class="about-thumb2 mb-60 mb-xl-0"> 
                        <div class="about-img-1">
                            <img src="assets/img/about_modular.png" alt="BoxKing Modular Fabrication">
                        </div>
                        <div class="about-counter-wrap style2 jump-reverse">
                            ...
                            <h3 class="about-counter-number"><span class="counter-number">100</span>%</h3>
                            <p class="about-counter-text">One-Trip Containers</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="title-area mb-25">
                        ...
                        <p class="sec-text">BoxKing Modular Solutions combines the expertise of certified combination welders and master carpenters to create premium modular buildings that are durable, functional, and built to the highest standards.  
                        </p>
                    </div>
                    ...
                    <div class="about-grid-wrap">
                        ...
                        <div class="about-grid-details">
                            ...
                            <p class="text">To deliver state-of-the-art modular container structures engineered for longevity, strength, and modern architectural elegance.</p>
                        </div>
                    </div>
                    <div class="about-grid-wrap">
                        <div class="icon">
                    ...
                    <div class="btn-group mt-60">
                        <a href="contact.php" class="btn style3">Get Free Quote <i class="ri-arrow-right-up-line"></i></a>
                    </div>                
                </div>
            </div>
        </div>
                            ...
                            <div class="testi-card">
                                ...
                                <div class="testi-card_content">
                                    ...
                                    <div class="testi-card-profile">
                                        ...
                                        <span class="testi-profile-desig">CEO at BoxKing</span>                                                                       
                                    </div>
                                </div>                        
                            </div>
                        </div>
