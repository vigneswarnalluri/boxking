...
<body>
	...
	******************************** -->
                    ...
                    <div class="row align-items-center justify-content-lg-start justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a href="index.php"><img src="assets/img/logo-white.svg" alt="logo"></a>
                            </div>
                        </div>
                        ...
                        <div class="col-auto d-xl-block d-none">
                            <div class="header-button">
                                ...
                                <a href="about.php" class="btn style2 d-xxl-flex d-none">GET IN TOUCH <i class="ri-arrow-right-up-line"></i></a>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-8">
                                ...
                                <div class="btn-group" data-ani="slider-custom-anim-left" data-ani-delay="0.4s">
                                    <a href="about.php" class="btn style2">REQUEST A FREE ESTIMATE <i class="ri-arrow-right-up-line"></i></a>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-7">
                                    <div class="why-content-wrap">
                                        ...
                                        <div class="btn-group mt-35">
                                            <a href="service.php" class="btn style3">More Details <i class="ri-arrow-right-up-line"></i></a>
                                        </div>
                                    </div>                                
                                </div>
                            </div>
                ...
                <div class="col-xl-6">
                    <div class="benefit-wrap5">
                        <div class="title-area mb-40">
                            ...
                            <h2 class="sec-title">Reasons why people choose 
                                ‘Construz’</h2>
    ...
    <section class="contact-area-2 space overflow-hidden">        
        <div class="container">
            <div class="contact-wrap2 space overflow-hidden" data-bg-src="assets/img/bg/contact-bg4-1.png">
                        ...
                        <div class="portfolio-card style5">
                            ...
                            <div class="portfolio-card-details">
                                <div class="media-left">
                                    ...
                                    <h4 class="portfolio-card-title"><a href="project-details.php">Modern pattern style for house roof</a></h4>                     
                                </div>
                                <div class="btn-group">
                                    <a href="project-details.php" class="btn style2">
        ...
        <div class="container">
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                ...
                <div class="col-md-auto">
                    <div class="sec-btn">
                        <a href="blog.php" class="btn">View all post <i class="ri-arrow-right-up-line"></i></a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card style5">
                        <div class="blog-img">
                            ...
                            <div class="blog-date">
                                <a href="blog.php"><span>22</span>JUN</a>
                                <div class="year">2024</div>
                            </div>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.php">By Jr. Saller</a>
                                <a href="blog.php">News in 2024</a>
                            </div>
                            <h3 class="blog-title"><a href="blog-details.php">Protecting your roof from storm damage</a></h3>
                            <a href="blog-details.php" class="btn style-border4" tabindex="0">Read More <i class="ri-arrow-right-up-line"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card style5">
                        <div class="blog-img">
                            ...
                            <div class="blog-date">
                                <a href="blog.php"><span>14</span>FEB</a>
                                <div class="year">2024</div>
                            </div>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.php">By Ashik</a>
                                <a href="blog.php">News in 2024</a>
                            </div>
                            <h3 class="blog-title"><a href="blog-details.php">Roofing are fact makes easier 10 reason</a></h3>
                            <a href="blog-details.php" class="btn style-border4" tabindex="0">Read More <i class="ri-arrow-right-up-line"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card style5">
                        <div class="blog-img">
                            ...
                            <div class="blog-date">
                                <a href="blog.php"><span>09</span>JUN</a>
                                <div class="year">2024</div>
                            </div>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.php">By Jekson</a>
                                <a href="blog.php">News in 2024</a>
                            </div>
                            <h3 class="blog-title"><a href="blog-details.php">Why roofing material warranties important?</a></h3>
                            <a href="blog-details.php" class="btn style-border4" tabindex="0">Read More <i class="ri-arrow-right-up-line"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="cta-area-5">
        <div class="container">
            <div class="cta-wrap5" data-bg-src="assets/img/bg/cta-bg5-1.png">
                ...
                <a class="btn style4" href="contact.php">Start your free quote <i class="ri-arrow-right-up-line"></i></a>
            </div>
    ...
    <!--==============================
        Footer Area
    ==============================-->
    <footer class="footer-wrapper footer-layout4" data-bg-src="assets/img/bg/footer-bg1-1.png">    
        <div class="container">
